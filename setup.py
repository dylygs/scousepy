...
PACKAGENAME = metadata.get('package_name', 'scousepy')
DESCRIPTION = metadata.get('description', 'A rewrite of jdhenshaw/SCOUSE in Python 3.6')
AUTHOR = metadata.get('author', 'Jeremy Atkins')
